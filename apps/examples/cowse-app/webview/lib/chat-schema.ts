...
import { z } from "zod";
import { AutoApproveSchema } from "./auto-approve";
import { ModelRuntimeSettingsSchema } from "./model-runtime-settings";
...
export const ChatSessionConfigSchema = z.object({
	...
	reasoningEffort: z
		...
		.optional(),
	modelSettings: ModelRuntimeSettingsSchema.optional(),

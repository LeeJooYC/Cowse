...
describe("WelcomeScreen", () => {
	...
	it("renders every known project in the opened workspace menu", async () => {
		...
		expect(heading?.textContent).toBe("有什么可以帮忙的？");
		expect(heading?.classList.contains("sr-only")).toBe(true);
		expect(container.querySelector("[data-welcome-hero]")).not.toBeNull();
		expect(
			container.querySelector("[data-welcome-hero] img")?.getAttribute("src"),
	...
	it("selects 即时会话 from the pathless workspace menu", async () => {

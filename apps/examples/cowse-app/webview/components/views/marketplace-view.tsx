...
const primitivePageDetails = {
	mcp: {
		title: "MCP 服务",
		description: "在此 CLI 环境中安装模型上下文协议（MCP）服务。",
		emptyInstalled: "尚未安装 MCP 服务。请浏览扩展市场或手动添加服务。",
		emptyCatalog: "没有符合当前筛选条件的 MCP 服务。",
		icon: Server,
	},
	skill: {
		title: "技能",
		description: "管理已安装的技能，并从扩展市场添加新技能。",
		emptyInstalled: "尚未安装技能。请前往扩展市场添加。",
	...
	plugin: {
		...
		emptyInstalled: "尚未安装插件。请前往扩展市场添加。",
...
const directoryPageDetails: MarketplacePageDetails = {
	title: "扩展市场",
	description: "浏览 Cline 社区精选的插件、MCP 服务和技能。",
	emptyInstalled: "尚未安装任何扩展。",
	emptyCatalog: "没有符合当前筛选条件的扩展。",
	icon: Store,
};

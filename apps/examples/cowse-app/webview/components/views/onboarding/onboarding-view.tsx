...
import { CowseWelcomeHero } from "@/components/cowse-welcome-hero";
		...
		<OnboardingContent surface="transparent">
			<div className="flex flex-col items-center py-4 text-center">
				<div className="w-full">
					<CowseWelcomeHero compact />
				</div>
				<h1 className="mt-5 text-4xl font-semibold text-foreground">牛马</h1>
				<p className="mt-2 text-lg text-foreground">你的本地工作助手</p>
				<p className="mt-6 text-md text-muted-foreground">
					牛马由完整 Cline Core 驱动，可以读取和修改文件、运行命令，并在你选择的工作目录中完成任务。
				</p>
				<Button
		...
		<OnboardingContent surface="panel">
			<div className="flex flex-col">
				...
				<p className="mt-4 text-sm text-muted-foreground">
					选择 Cline Core 连接模型的方式。之后可以随时在设置中添加更多服务。
				</p>
			</div>

...
import { getBuiltinToolLabels } from "@/lib/builtin-tool-labels";
...
const sectionDescriptions: Record<CustomizationSection, string> = {
	Rules: "查看影响牛马行为的项目规则和全局规则文件。",
	Hooks: "检查钩子配置和最近的执行状态。",
	MCP: "管理已安装的 MCP 服务，并从扩展市场添加新服务。",
	Skills: "管理已安装的技能，并从扩展市场添加新技能。",
	Agents: "查看从本地设置中发现的智能体。",
	Plugins: "管理已安装的插件，并从扩展市场添加新插件。",
	Tools: "查看内置工具和插件提供的工具。",
};
